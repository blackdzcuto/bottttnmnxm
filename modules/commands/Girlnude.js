Nude Gái Xinh Cực Bổ Mắt ( Lưu Ý Đây Là Lệnh Ảnh 18+ Cân Nhắc Trước Khi Sử Dụng)",
...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      if(money < 5000) api.sendMessage("Bạn cần 300 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
