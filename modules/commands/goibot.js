...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["chào bạn tôi là bot của Vũ","Bạn có biết tôi yêu bạn vai lon","M ko bt là t là đại ca tịnh thất bồng lai à hoho","Vợ gọi có việc gì không?","Sử dụng callad để liên lạc với admin!","Em là bot cute nhất hành tinh","Chúa phù hộ em","Em đây~~~~","Yêu anh Vũ nhất","Đi giải cứu Diễm Mi nàooo","Gọi tao lm gì nói lẹ","Sao thế công chúa","mô phật", "Tuyển phi công ạ","Làm bồ em ko ạ? dui lắm","Cậu cô đơn ko?","Tuyển ghệ đít bự đi bay lắc","Được của ló :)))", "Mong thí chủ đừng spam có đc hog hả","Đừng khen em ngại quá hí hí","Làm chồng em ko ạ?","Đừng spam em nha :<<","Bằng lái hủ tiếu kinh nghiệm đầy minh tuyển ghệ đít bự","Tịnh tâm","Omg yêu mọi người <3","Mik đang ế ai hốt yêu lun 😼","Chồng em đây rồi","Nứng à kiu hoài","Mik Hog Tồi Nhoaaa","ăn cuk hog mà kiu","hỏ ai kiu bot dọ"];
