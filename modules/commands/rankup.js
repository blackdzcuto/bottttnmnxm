...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
    ...
    if (level > curLevel && level != 1) {
        ...
        if (existsSync(__dirname + `/cache/rankup/rankupv2.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup/rankupv2.gif`), mentions: [{ tag: name, id: senderID }] };
...
module.exports.languages = {
    "vi": {
        ...
        "levelup": "➢ 𝐋𝐞𝐯𝐞𝐥 𝐔𝐩 {level} ✘\n📢 𝐂𝐨̂́ 𝐆𝐚̆́𝐧𝐠 Tưởng Tác Đ𝐞̂̉ Đ𝐚̣𝐭 𝐓𝐡𝐚̀𝐧𝐡 𝐓𝐮̛̣𝐮 𝐂𝐚𝐨 𝐍𝐡𝐞́ {name} 🥳🎊 "
    },
    "en": {
        "on": "on",
        "off": "off",
