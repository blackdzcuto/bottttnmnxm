...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		api.changeNickname(`[ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "Bot Cre By PDUY" : global.config.BOTNAME}`, threadID, api.getCurrentUserID());
		return api.sendMessage(`⋙ 𝙆𝙚̂́𝙩 𝙉𝙤̂́𝙞 𝙏𝙝𝙖̀𝙣𝙝 𝘾𝙤̂𝙣𝙜 ⋘\n\n📩🍁•🐰𝙇𝙚 𝙑𝙞𝙚𝙩 𝙏𝙞𝙚𝙥 🐰•🍁📩\n➽ 𝑩𝒐𝒕 Đ𝒄 Đ𝒊𝒆̂̀𝒖 𝑯𝒂̀𝒏𝒉 𝑩𝒚 Nguyễn Phát\n➽ 𝑳𝒊𝒏𝒌 𝑭𝑩 𝑨𝑫𝑴𝑰𝑵\n📲https://www.facebook.com/SupporNgonTinhAtibanoff \nBot hiện tại có 570 lệnh\n\n✘▬ ▬ ▬ ▬𝑅𝑈𝐿𝐸▬ ▬ ▬ ▬✘\n➢ 𝑲 𝑺𝒑𝒂𝒎 𝑩𝒐𝒕 ,\n➢ 𝑲 𝑳𝒂̆𝒏𝒈 𝑴𝒂̣ 𝑪𝒉𝒖̛̉𝒊 𝑩𝒐𝒕\n➢ 𝑻𝒐̂𝒏 𝑻𝒓𝒐̣𝒏𝒈 𝑨𝑫𝑴𝑰𝑵 𝒗𝒂̀ 𝑩𝒐𝒕\n➢ 𝑴𝒐̂̃𝒊 𝑵𝒉𝒐́𝒎 𝑪𝒉𝒊̉ Đ𝒖̛𝒐̛̣𝒄 1 𝑩𝒐𝒕 , 𝑵𝒆̂́𝒖 𝑷𝒉𝒂́𝒕 𝑯𝒊𝒆̣̂𝒏 𝑩𝒐𝒕 𝑺𝒆̃ 𝑶𝒖𝒕 🚫\n\n✘▬ ▬ 𝐇𝐮̛𝐨̛́𝐧𝐠 𝐃𝐚̂̃𝐧 𝐒𝐃 ▬ ▬✘\n➢ 𝑮𝒐̃ /𝑴𝒆𝒏𝒖 𝑯𝒐𝒂̣̆𝒄 /𝑯𝒆𝒍𝒑 Đ𝒆̂̉ 𝑿𝒆𝒎 𝑳𝒆̣̂𝒏𝒉\n🌺𝑪𝒉𝒖́𝒄 𝑩𝒂̣𝒏 𝑺𝒂̀𝒊 𝑩𝒐𝒕 𝑽𝑽 ❤`, threadID);
			}
	else {
		try {
			...
			const pathGif = join(path,`hiv2.gif`);
